...
/**
 * Fixed prompt suite used by the Coach screen's manual headless gate runner.
 * The prompts intentionally differ from current queue values so meaningful changes are detectable.
 */
export const TEST_PROMPTS: CoachPromptCase[] = [
